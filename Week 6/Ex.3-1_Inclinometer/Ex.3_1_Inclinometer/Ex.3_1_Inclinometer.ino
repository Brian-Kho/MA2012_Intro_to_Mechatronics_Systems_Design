...
void loop() {
  ...
  if(accelZ >= 0.9848){
    ...
    delay(100);
    Serial.print("Z tilted: "); Serial.print("0"); Serial.print("degree");
  }
  else if(accelZ < 0.9848){
    double degree;
    degree = acos(accelZ) / Pi *180;
    digitalWrite(pin8, LOW);
    Serial.print("Z tilted: "); Serial.print(degree); Serial.print("degrees");
  }
